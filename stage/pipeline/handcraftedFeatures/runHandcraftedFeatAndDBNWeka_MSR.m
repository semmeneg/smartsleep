...
subFolder = '2016-12-06_HandcraftedFeat_DBN_Weka_with_MSR';
...
rbmTrainer = RBMFeaturesTrainer(layersConfig, struct('data', allData, 'labels', allLabels));
...
writer = WekaArffFileWriter(higherOrderFeaturesDBN.features, allLabels, selectedClasses, arffFileName);
writer.run();
