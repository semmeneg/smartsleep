...
processingOutputFolder = '2016-12-21_Raw_DBN_Weka_with_MSR_Zephyr';
...
props.samplingFrequency = ceil(19.7); % MSR 145B frequency: ~19.7 Hz (512/26) rounded up for interpolation
